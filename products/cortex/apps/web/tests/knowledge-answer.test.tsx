...
it("renders generated and retrieved text inert with a visible version reference", () => {
  state.current = { result: { answer: "<script>alert(1)</script>", synthetic: true, reference: { page_id: "id", page_version_id: "version-1", title: "<img src=x>", path: "policy", source_titles: ["Visible memo"] } } };
